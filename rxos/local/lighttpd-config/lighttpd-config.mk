...
LIGHTTPD_SED_CMDS += s|%UPLOAD_LIMIT%|$(BR2_LIGHTTPD_UPLOAD_LIMIT)|g;
LIGHTTPD_SED_CMDS += s|%UPLOAD_TMPDIR%|$(call qstrip,$(BR2_LIGHTTPD_UPLOAD_TMPDIR))|g;
