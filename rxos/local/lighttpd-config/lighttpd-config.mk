...
LIGHTTPD_SED_CMDS += s|%INTERNALDIR%|$(call qstrip,$(BR2_LIGHTTPD_INTERNALDIR))|g;
LIGHTTPD_SED_CMDS += s|%EXTERNALDIR%|$(call qstrip,$(BR2_LIGHTTPD_EXTERNALDIR))|g;

LIGHTTPD_HTMLDIR = $(call qstrip,$(BR2_LIGHTTPD_SERVER_ROOT))

define LIGHTTPD_CONFIG_INSTALL_TARGET_CMDS
	sed -i '$(LIGHTTPD_SED_CMDS)' $(@D)/lighttpd.conf
