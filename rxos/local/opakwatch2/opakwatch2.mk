...
define OPAKWATCH2_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -Dm0644 $(@D)/opaks.incron $(TARGET_DIR)$(call qstrip,$(BR2_INCRON_SERVICE_CONFDIR))/opaks.incron
	$(SED) '$(OPAKWATCH2_SED_CMDS)' $(TARGET_DIR)$(call qstrip,$(BR2_INCRON_SERVICE_CONFDIR))/opaks.incron
endef
