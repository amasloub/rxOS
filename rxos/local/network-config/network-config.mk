...
define NETWORK_CONFIG_INSTALL_TARGET_CMDS
	...
	sed -i 's|%IFACE%|$(NETWORK_CONFIG_AP_IF)|;s|%SSID%|$(NETWORK_CONFIG_AP_NAME)|;s|%IP%|$(NETWORK_CONFIG_AP_IP)|;s|%START%|$(NETWORK_CONFIG_DHCP_START)|;s|%END%|$(NETWORK_CONFIG_DHCP_END)|;s|%NETMASK%|$(NETWORK_CONFIG_NETMASK)|;s|%TAG%|$(NETWORK_CONFIG_TAG)|' \
