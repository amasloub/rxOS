...
FSAL_SED_CMDS += s|%BLACKLIST%|$(shell $(LISTIFY) $(BLACKLIST))|g;
BASEDIRS = $(call qstrip,$(BR2_STORAGE_PRIMARY))
BASEDIRS += $(call qstrip,$(BR2_STORAGE_SECONDARY))
...
FSAL_SED_CMDS += s|%BLACKLIST%|$(shell $(LISTIFY) $(BLACKLIST))|g;
FSAL_SED_CMDS += s|%BASEDIRS%|$(shell $(LISTIFY) $(BASEDIRS))|g;
